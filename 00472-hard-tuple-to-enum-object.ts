...
type Enum<T extends readonly string[], N extends boolean = false, R = {}, I extends number[] = []> =
  T extends readonly [infer F extends string, ...infer Rest extends string[]]
    ? N extends true
      ? Enum<Rest, N, R & Record<Capitalize<F>, I['length']>, [...I, 1]>
      : Enum<Rest, N, R & Record<Capitalize<F>, F>>
    : Readonly<R>
