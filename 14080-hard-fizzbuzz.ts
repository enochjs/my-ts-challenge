...
type FizzBuzz<N extends number, R extends string[] = [], F extends number[] = [], B extends number[] = []> =
  N extends R['length']
    ? R
    : F["length"] extends 2
      ? B["length"] extends 4
        ? FizzBuzz<N, [...R, 'FizzBuzz'], [], []>
        : FizzBuzz<N, [...R, 'Fizz'], [], [...B, 1]>
      : B["length"] extends 4
        ? FizzBuzz<N, [...R, 'Buzz'], [...F, 1], []>
        : FizzBuzz<N, [...R, ToString<[1, ...R]['length']>], [...F, 1], [...B, 1]>
