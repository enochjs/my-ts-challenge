...
// ============= Your Code Here =============
type ICurry<P extends any[], R> =
  P extends []
    ? R
    : <P1 extends any[]>(...args: P1) => P extends [...P1, ...infer P2] ? ICurry<P2, R> : R

declare function DynamicParamsCurrying<P extends any[], R>(fn: (...args: P) => R): ICurry<P, R>
