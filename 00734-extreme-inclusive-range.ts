...
// type a = LargerThan<6, 5>

type InclusiveRange<Lower extends number, Higher extends number, R extends number[]=[], C extends number[] = [], flag=Lower extends 0 ? true : false> =
  LargerThan<Lower, Higher> extends true
    ? []
    : C['length'] extends Higher
        ? [...R, C["length"]]
        : flag extends true
          ? InclusiveRange<Lower, Higher, [...R, C['length']], [...C, 1], true>
          : InclusiveRange<Lower, Higher, R, [...C, 1], [...C, 1]["length"] extends Lower ? true : false>
