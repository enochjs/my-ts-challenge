...
// ============= Your Code Here =============
type InclusiveRange<Lower extends number, Higher extends number, I extends number[] = [], R extends number[] = [], Flag extends boolean = I["length"] extends Lower ? true : false> =
  Flag extends true
    ? I['length'] extends Higher
      ? [...R, Higher]
      : InclusiveRange<Lower,Higher, [...I, 1], [...R, I['length']], true>
    : I['length'] extends Higher
      ? []
      : InclusiveRange<Lower,Higher, [...I, 1], R>