...
// ============= Your Code Here =============
type NumberToArr<X extends number, R extends number[] = []> = R["length"] extends X ? R : NumberToArr<X, [...R, 1]>
type LargeThan<X, Y> =
  X extends [infer X1, ...infer XRest]
    ? Y extends [infer Y1, ...infer YRest]
      ? LargeThan<XRest, YRest>
      : true
    : false


type InclusiveRange<Lower extends number, Higher extends number, Index extends number[]=[], Flag=Lower extends 0 ? true : false, R extends number[]=[]> =
  LargeThan<NumberToArr<Lower>, NumberToArr<Higher>> extends true
    ? []
    : Index["length"] extends Higher
      ? [...R, Higher]
      : InclusiveRange<Lower, Higher, [...Index, 1], Flag extends false ? [...Index, 1]["length"] extends Lower ? true : false : true, Flag extends true ? [...R, Index["length"]] : R>
